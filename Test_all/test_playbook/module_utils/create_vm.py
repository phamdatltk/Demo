...
def write_payload_to_file(client, vdc_name, catalogName, vapp_template_name, vms_list, network_name, storage_profile_name, placement_policy_name):
    ...
    payload = f"""<?xml version="1.0" encoding="UTF-8"?>
        ...
        <root:SourcedItem>
                <root:Source href="{vapp_vm_template_href}" id="{vapp_vm_template_uuid}" name="{master_vm}" type="application/vnd.vmware.vcloud.vm+xml" />
                <root:InstantiationParams>
                    <root:GuestCustomizationSection>
                        ...
                        <root:ComputerName>{master_vm}</root:ComputerName>
                    </root:GuestCustomizationSection>
    ...
    index = 1
    if len(vms_list) > index:
        slave01_vm = vms_list[1]
        slave02_vm = vms_list[2]
        payload = f"""<?xml version="1.0" encoding="UTF-8"?>
        <root:RecomposeVAppParams xmlns:root="http://www.vmware.com/vcloud/v1.5" xmlns:ns1="http://schemas.dmtf.org/ovf/envelope/1">
        <root:SourcedItem>
                <root:Source href="{vapp_vm_template_href}" id="{vapp_vm_template_uuid}" name="{master_vm}" type="application/vnd.vmware.vcloud.vm+xml" />
        ...
        <root:SourcedItem>
                <root:Source href="{vapp_vm_template_href}" id="{vapp_vm_template_uuid}" name="{slave01_vm}" type="application/vnd.vmware.vcloud.vm+xml" />
                <root:InstantiationParams>
                    <root:GuestCustomizationSection>
                        <ns1:Info />
                        <root:Enabled>true</root:Enabled>
                        ...
                        <root:AdminAutoLogonCount>0</root:AdminAutoLogonCount>
                        <root:ResetPasswordRequired>false</root:ResetPasswordRequired>
                        <root:ComputerName>{slave01_vm}</root:ComputerName>
                    </root:GuestCustomizationSection>
                    <root:NetworkConnectionSection>
                        <ns1:Info />
                        <root:PrimaryNetworkConnectionIndex>0</root:PrimaryNetworkConnectionIndex>
        ...
        <root:SourcedItem>
                <root:Source href="{vapp_vm_template_href}" id="{vapp_vm_template_uuid}" name="{slave02_vm}" type="application/vnd.vmware.vcloud.vm+xml" />
                <root:InstantiationParams>
                    <root:GuestCustomizationSection>
                        <ns1:Info />
                        <root:Enabled>true</root:Enabled>
                        ...
                        <root:AdminAutoLogonCount>0</root:AdminAutoLogonCount>
                        <root:ResetPasswordRequired>false</root:ResetPasswordRequired>
                        <root:ComputerName>{slave02_vm}</root:ComputerName>
                    </root:GuestCustomizationSection>
                    <root:NetworkConnectionSection>
                        <ns1:Info />
                        <root:PrimaryNetworkConnectionIndex>0</root:PrimaryNetworkConnectionIndex>
