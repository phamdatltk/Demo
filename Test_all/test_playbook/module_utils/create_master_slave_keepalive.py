...
def create_vm(client, vdc_name, catalogName, vapp_template_master_name, vapp_template_worker_name, vapp_template_keepalive_name, vapp_name, password, vm_list, network_name):
    vapp_id = get_vapp_id(client, vapp_name, vdc_name)
    uri = client.get_api_uri()
    url = f"{uri}/vApp/{vapp_id}/action/recomposeVApp"
    
    write_payload_to_file(client, vdc_name, catalogName, vapp_template_master_name, vapp_template_worker_name, vapp_template_keepalive_name, password, vm_list, network_name)
...
def write_payload_to_file(client, vdc_name, catalogName, vapp_template_master_name, vapp_template_worker_name, vapp_template_keepalive_name, password, vm_list, network_name):
...
def write_payload_to_file_without_master(client, vdc_name, catalogName, vapp_template_worker_name, vapp_template_keepalive_name, password, vm_list, network_name):
    vapp_template_worker_uuid = get_vapp_template_uuid(client, catalogName, vapp_template_worker_name)
    vapp_vm_template_worker_href = get_vapp_vm_template_href(client, vapp_template_worker_uuid)
    vapp_vm_template_worker_uuid = get_vapp_vm_template_uuid(client, vapp_template_worker_uuid)
...
def create_vm_without_master(client, vdc_name, catalogName, vapp_template_worker_name, vapp_template_keepalive_name, vapp_name, password, vm_list, network_name):
    vapp_id = get_vapp_id(client, vapp_name, vdc_name)
    uri = client.get_api_uri()
    url = f"{uri}/vApp/{vapp_id}/action/recomposeVApp"
    
    write_payload_to_file_without_master(client, vdc_name, catalogName, vapp_template_worker_name, vapp_template_keepalive_name, password, vm_list, network_name)
