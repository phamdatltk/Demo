...
def eg_dnat_rule_argument_spec():
    return dict(
        ...
        internal_address=dict(type='str', required=False),
...
class SNAT_Rule(VcdAnsibleModule):
    ...
    def create(self):
        ...
        internal_address=params.get('internal_address')
        ...
        create_snat_rule(self.client, name_snat_rule, edge_gw_id, {"ip_address": translated_address,  "ip_address_internal": internal_address,"ip_address_destination": destination_address,"snat_priority": priority})
