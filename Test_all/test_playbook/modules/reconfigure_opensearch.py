...
from ansible.module_utils.reconfigure_opensearch import reconfigure_vm_cpu_memory
from ansible.module_utils.reconfigure_opensearch import reconfigure_vm_cpu
from ansible.module_utils.reconfigure_opensearch import reconfigure_vm_memory
import time
from ansible.module_utils.util import list_vm_opensearch

RECONFIGURE_VM_OPERATIONS = ['scale']
RECONFIGURE_VM_STATES = ['present']
